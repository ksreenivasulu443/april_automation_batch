"""This module file is create to practice python negative index slicing and
    created by khushboo on 03/05/2024"""
...
print(f"the third_value of given character {str} is :", str[-3])
