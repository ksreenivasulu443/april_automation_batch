...
# for i in l:
#     if i > 6:
#         print(f"the I reached beyound {i}:", i)
#     else:
#         print (f"I {i} value is in range:",i)
#
...
#
# # print(f"sqare of 1:",ls [0] * ls [0])
# # print(f"sqare of 2:",ls [1] * ls [1])
# # print(f"sqare of 3:",ls [2] * ls [1])
#
# for i in ls:
#     print (f"the square value {i} * {i}:",i * i)
